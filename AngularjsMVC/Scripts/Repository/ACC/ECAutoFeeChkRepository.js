...
.factory("ECAutoFeeChkRepository", ["$http", "baseUrl", function ($http, baseUrl) {
    var areaUrl = baseUrl + 'ACC/ECAutoFeeChk/';
    return {
        getEcfaList: function (data) {
            return $http.post(areaUrl + 'GetEcfaList', data);
        },
